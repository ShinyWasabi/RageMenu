...
PROC SUBMENUS_DRAW_TELEPORT_CUSTOM_TELEPORT()
    IF MENU_BEGIN_SUBMENU(SUBMENUS_TELEPORT_CUSTOM_TELEPORT)
        MENU_KEYBOARD_FLOAT("X Axis:", vCustomTpCoords.x, "Set target X position.")
        MENU_KEYBOARD_FLOAT("Y Axis:", vCustomTpCoords.y, "Set target Y position.")
        MENU_KEYBOARD_FLOAT("Z Axis:", vCustomTpCoords.z, "Set target Z position.")
